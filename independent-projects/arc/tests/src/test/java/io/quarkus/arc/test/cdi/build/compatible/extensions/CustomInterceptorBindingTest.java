...
public class CustomInterceptorBindingTest {
    ...
    public static class MyExtension implements BuildCompatibleExtension {
        ...
        public void discovery(MetaAnnotations meta, ScannedClasses scan) {
            scan.add("io.quarkus.arc.test.cdi.build.compatible.extensions.CustomInterceptorBindingTest$MyInterceptor");
            scan.add("io.quarkus.arc.test.cdi.build.compatible.extensions.CustomInterceptorBindingTest$MyService");

        ...
        public void synthesise(SyntheticComponents syn, Types types) {
            ...
            syn.addBean(MyPojo.class)
                    ...
                    .withParam("data", AnnotationBuilder.of(MyComplexValue.class)
                            ...
                            .member("type", types.ofClass(
                                    "io.quarkus.arc.test.cdi.build.compatible.extensions.SyntheticBeanTest$MyEnum")
                                    .declaration())
                            .member("nested", AnnotationBuilder.of(types.ofClass(
                                    "io.quarkus.arc.test.cdi.build.compatible.extensions.SyntheticBeanTest$MySimpleValue")
                                    .declaration()).value("no").build())
                            .build())

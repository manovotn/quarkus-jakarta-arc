...
public class CustomQualifierTest {
    ...
    public static class MyExtension implements BuildCompatibleExtension {
        ...
        public void discovery(MetaAnnotations meta, ScannedClasses scan) {
            scan.add("io.quarkus.arc.test.cdi.build.compatible.extensions.CustomQualifierTest$MyServiceFoo");
            scan.add("io.quarkus.arc.test.cdi.build.compatible.extensions.CustomQualifierTest$MyServiceBar");

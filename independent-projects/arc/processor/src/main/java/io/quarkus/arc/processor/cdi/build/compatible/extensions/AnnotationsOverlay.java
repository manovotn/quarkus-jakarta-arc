...
abstract class AnnotationsOverlay<JandexDeclaration extends org.jboss.jandex.AnnotationTarget> {
    private final Map<org.jboss.jandex.EquivalenceKey, AnnotationSet> overlay = new HashMap<>();
    private final Map<org.jboss.jandex.EquivalenceKey, JandexDeclaration> overlaidDeclarations = new HashMap<>();
    ...
    Collection<JandexDeclaration> overlaidDeclarationsWithAnnotation(DotName annotationName) {
        Set<org.jboss.jandex.EquivalenceKey> keysWithAnnotation = new HashSet<>();
        for (Map.Entry<org.jboss.jandex.EquivalenceKey, AnnotationSet> entry : overlay.entrySet()) {
